...
public abstract class AbstractMaze implements Maze {
  ...
  public void addMazeDoors() {
    ...
    // CHANGED
    int totalWallsToRemove = this.numOfCols * this.numOfRows - 1;
  ...
  public void addLocations() {
    ...
    for (int idx = 0; idx < numOfCols; idx++) { // CHANGED!!
      for (int jdx = 0; jdx < numOfRows; jdx++) {
        
        //Point newPoint = new Point(jdx, idx); // CHANGED!!
        Point newPoint = new Point(idx, jdx);
