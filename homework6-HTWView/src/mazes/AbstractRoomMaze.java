...
public abstract class AbstractRoomMaze extends AbstractMaze {
  ...
  /**
   * Returns the tracked tunnel informations so that controller knows the players travel history.
   */
  public List<Location> giveTunnelLocations() {
    List<Location> tunnelLocations = this.visited;
    this.visited = new ArrayList<Location>();
    return tunnelLocations;
